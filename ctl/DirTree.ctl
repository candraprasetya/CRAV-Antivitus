...
Begin VB.UserControl DirTree 
   ...
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin Project1.ucTreeView tree1 
      Height          =   3015
      Left            =   0
      TabIndex        =   11
      Top             =   0
...
If tree1.GetNodeKey(tree1.SelectedNode) <> "Komputer" Then
frmMain.txtPath.Text = nPath(tree1.GetNodeKey(tree1.SelectedNode))
Else
frmMain.txtPath.Text = "Komputer"
End If
End Sub
Public Function nPath(ByVal StrInW As String) As String
On Error Resume Next
If Right$(StrInW, 1) <> ChrW$(92) Then
nPath = StrInW & ChrW$(92)
Else
nPath = StrInW
End If
End Function
